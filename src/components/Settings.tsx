      ...
      <CardContent className="p-0">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium w-24 text-muted-foreground">Color</span>
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium w-24 text-muted-foreground">Font size</span>
            <div className="flex items-center gap-0 border rounded-md overflow-hidden">
              <button
                type="button"
                className={cn(
                  "px-3 py-1 text-sm transition-colors", 
                  settings.fontSize === 'small' ? "bg-accent text-accent-foreground" : "hover:bg-accent/50"
                )}
              ...
              <button
                ...
                className={cn(
                  "px-3 py-1 text-sm transition-colors", 
                  settings.fontSize === 'medium' ? "bg-accent text-accent-foreground" : "hover:bg-accent/50"
                )}
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium w-24 text-muted-foreground">Card width</span>
            <div className="flex items-center gap-0 border rounded-md overflow-hidden">
              <button
                type="button"
                className={cn(
                  "px-3 py-1 text-sm transition-colors", 
                  settings.cardWidth === 'small' ? "bg-accent text-accent-foreground" : "hover:bg-accent/50"
                )}
              ...
              <button
                ...
                className={cn(
                  "px-3 py-1 text-sm transition-colors", 
                  settings.cardWidth === 'medium' ? "bg-accent text-accent-foreground" : "hover:bg-accent/50"
                )}
